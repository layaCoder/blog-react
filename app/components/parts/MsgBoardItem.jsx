...
class MsgBoardItem extends Component {
    ...
    btnSaveReply = () => {
        console.log('btnSaveReply running')
            ...
            <div>
                <Row>
                    <Row className='msgBoardItem-row'>
                        ...
                        <Row>
                            <div className='msgBoardItem-content' dangerouslySetInnerHTML={{ __html: this.props.msgItem.content }}>
                            </div>
                        </Row>
                        <Row>
                        ...
                        <Row>
                            <Col span={2} offset={2}>
                                <span className='msgBoardItem-reply-btn' onClick={this.showModal}>reply</span>
                            </Col>
                        </Row>
                    </Row>
                </Row>
                ...
                <div>
                    ...
                    >
                        <p>
                            reply to @{this.props.msgItem.author}
                        </p>
                        <TextArea
                        ...
                        <Row style={{ marginTop: '2%' }}>
                            <Col span={2} offset={21}>
                                <Button type='default' size='small' onClick={this.btnSaveReply} loading={this.state.btnReplyLoading}> Save </Button>
                            </Col>
                        </Row>
                    </Modal>
                </div>
